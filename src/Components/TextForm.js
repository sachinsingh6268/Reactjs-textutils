    ...
    return (
        <>
            <div className="mb-3 mx-3">
                ...
                <button className="btn btn-primary my-2 mx-2" disabled={text.length===0} onClick={changeToUppercase}>Change To Uppercase</button>
                <button className="btn btn-primary my-2 mx-2" disabled={text.length===0} onClick={changeToLowercase}>Change To Lowercase</button>
                <button className="btn btn-primary my-2 mx-2" disabled={text.length===0} onClick={clearText}>Clear Text Field</button>
                <button className="btn btn-primary my-2 mx-2" disabled={text.length===0} onClick={reverseText}>Reverse the Text</button>
            ...
            <div className="container">
                ...
                <p>{text.split(/\s+/).filter((element)=>{return element.length!==0}).length} words and {text.length} characters are there in this text</p>
                <h2>Preview</h2>
